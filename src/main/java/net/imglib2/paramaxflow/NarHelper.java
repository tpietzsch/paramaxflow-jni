...
public class NarHelper {
	...
	/**
	 * Loads the library compiled by the nar-maven-plugin. This function is called in Parametric.java.
	 * When you update the version number, consider to change the version number in Parametric.java as well.
	 *
	 * @param clazz
	...
	public static void loadLibrary( final Class< ? > clazz, final String groupId, final String artifactId, final String version ) {
		...
		//TODO: HongKee made a trick to find the url string from the actual resource.
		//TODO: @Florian: you can change this to the default model file or default .jug file
	...
	public static String loadNative( String libName, String libPath ) {
		...
		try {
			...
			InputStream in = Parametric.class.getResourceAsStream( libPath );
